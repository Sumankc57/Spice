...
namespace Spice.Areas.Customer.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> ManageOrder()
        {
            ...
            List<OrderHeader> OrderHeaderList = await _db.OrderHeader.Where(o => o.Status == SD.StatusSubmitted || o.Status == SD.StatusInProcess|| o.Status == SD.PaymentStatusPending).OrderByDescending(u => u.PickupTime).ToListAsync();
        ...
        public async Task<IActionResult> GetOrderDetails(int Id)
        {
            ...
            // this is code that i uncommited 
        ...
        {
           var model = _db.OrderHeader.Where(x => x.Status == SD.StatusCompleted);
            return View(model);
        }
        ...
        public async Task<IActionResult> OrderPickup(int productPage = 1, string searchEmail = null, string searchPhone = null, string searchName = null)
        {
            ...
            {
                OrderHeaderList = await _db.OrderHeader.ToListAsync();
            }
